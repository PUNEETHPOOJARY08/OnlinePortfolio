  ...
  const internships = [
    {
      ...
      description: 'Developed responsive and interactive web pages using HTML, CSS, and JavaScript, improving UI performance and design consistency.',
    ...
    },
    {
      ...
      description: 'Built full-stack web applications using the MERN stack (MongoDB, Express.js, React.js, Node.js), implementing CRUD operations and authentication features.',
