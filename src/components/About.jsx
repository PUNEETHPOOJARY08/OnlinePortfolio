...
const Hero = ({ scrollToSection }) => {
  ...
  const roles = ['Java Full Stack Developer', 'React Developer', 'Spring Boot Developer']
      ...
      <div className="hero-content">
        <div className="hero-text">
          <h1 className="hero-title">
            Hi, I'm <span className="highlight">Puneeth K</span>
          </h1>
          ...
          <p className="hero-description">
            ...
            Jdbc, Hibernate, RESTful APIs, SQL, HTML, CSS, JavaScript, and React.js. Skilled in developing 
            and deploying end-to-end web applications.
          </p>
          <div className="hero-buttons">
            ...
            <a
              href="/OnlinePortfolio/resume/resume.pdf"
              target="_blank"
          ...
          <div className="hero-social">
            ...
            <a href="tel:+919606301570" aria-label="Phone" title="Phone: +91 9606301570">
              <svg viewBox="0 0 24 24" fill="currentColor">
                <path d="M6.62 10.79c1.44 2.83 3.76 5.14 6.59 6.59l2.2-2.2c.27-.27.67-.36 1.02-.24 1.12.37 2.33.57 3.57.57.55 0 1 .45 1 1V20c0 .55-.45 1-1 1-9.39 0-17-7.61-17-17 0-.55.45-1 1-1h3.5c.55 0 1 .45 1 1 0 1.25.2 2.45.57 3.57.11.35.03.74-.25 1.02l-2.2 2.2z"/>
              </svg>
            </a>
            <a href="mailto:puneethbirwas@gmail.com" aria-label="Email" title="Email: puneethbirwas@gmail.com">
              <svg viewBox="0 0 24 24" fill="currentColor">
